...
The reference demo also completes with an intact ledger and no integrity failures. See the nested READMEs for the exact manual commands and the boundaries each test suite covers.
